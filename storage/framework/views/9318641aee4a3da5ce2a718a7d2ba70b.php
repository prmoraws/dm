<?php $__env->startSection('title', 'Ofícios de Evento'); ?>
 ...
 <?php $__env->slot('header', null, []); ?> 
    <div class="flex items-center space-x-3 animate-fade-in">
        ...
        <h2 class="capitalize font-semibold text-2xl text-gray-900 dark:text-gray-100 leading-tight">
            <?php echo e(__('Ofícios de Evento')); ?>
...
<div x-data="{
    ...
    viewOrDownload(oficioId) {
        if (this.isIos) {
            window.open('<?php echo e(route('evento.pdf.view', ['id' => 'TEMP_OFICIO_ID'])); ?>'.replace('TEMP_OFICIO_ID', oficioId), '_blank');
        } else {
            $wire.view(oficioId);
        }
    }
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('message') || session()->has('error')): ?>
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)" x-transition
                    class="rounded-lg shadow-lg my-6 p-4 border-l-4 <?php echo e(session()->has('message') ? 'bg-teal-50 dark:bg-teal-900/50 border-teal-500' : 'bg-red-50 dark:bg-red-900/50 border-red-500'); ?>">
                    <div class="flex items-center justify-between">
                        <p
                            class="text-sm font-medium <?php echo e(session()->has('message') ? 'text-teal-800 dark:text-teal-200' : 'text-red-800 dark:text-red-200'); ?>">
                            <?php echo e(session('message') ?? session('error')); ?>

                        </p>
                        <button @click="show = false"
                            class="<?php echo e(session()->has('message') ? 'text-teal-600 dark:text-teal-400' : 'text-red-600 dark:text-red-400'); ?>">&times;</button>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOpen): ?>
                    <div wire:key="create-edit-modal"
                        ...
                        x-data="{ open: <?php echo json_encode($isOpen, 15, 512) ?> }" x-show="open" x-on:keydown.escape.window="$wire.closeModal()"
                        ...
                        <div class="bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl w-full max-w-2xl p-6">
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">
                                <?php echo e($oficio_id ? 'Editar' : 'Criar'); ?> Ofício de Evento</h2>
                            <form wire:submit.prevent="store" class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div><label for="data_oficio"
                                        ...
                                        <input type="date" wire:model.defer="data_oficio" id="data_oficio"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div><label for="presidio_id"
                                        ...
                                        <select wire:model.live="presidio_id" id="presidio_id"
                                            class="w-full rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div><label for="assunto"
                                            class="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-300">Assunto
                                            do
                                            Evento</label>
                                        
                                        <input type="text" wire:model.defer="assunto" id="assunto"
                                            class="w-full rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['assunto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="md:col-span-2"><label for="dia_hora_evento"
                                            class="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-300">Data e
                                            Hora do Evento</label>
                                        
                                        <input type="datetime-local" wire:model.defer="dia_hora_evento"
                                            id="dia_hora_evento"
                                            class="w-full rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="md:col-span-2"><label for="descricao"
                                            class="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-300">Descrição
                                            do Evento</label>
                                        
                                        <textarea wire:model.defer="descricao" id="descricao" rows="3"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="md:col-span-2"><label for="materiais"
                                        ...
                                        <textarea wire:model.defer="materiais" id="materiais" rows="4"
                                            class="w-full rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600"></textarea>
                                    </div>
                                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isViewOpen && $selectedOficio): ?>
                    <div wire:key="view-modal"
                        class="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-md z-50 overflow-y-auto p-2 sm:p-4 md:p-10 flex flex-col items-center justify-start pt-6 sm:pt-10"
                        x-data="{ open: <?php echo json_encode($isViewOpen, 15, 512) ?> }" x-show="open" x-on:keydown.escape.window="$wire.closeViewModal()"
                        x-transition>
                        <div class="w-full max-w-[210mm] flex justify-end items-center mb-2 sm:mb-4 print:hidden">
                            <button onclick="printOficio()"
                                class="bg-blue-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm hover:bg-blue-700 transition flex items-center gap-1.5 sm:gap-2">
                            ...
                            <button wire:click="closeViewModal" type="button"
                                class="ml-2 sm:ml-4 p-1.5 sm:p-2 rounded-full text-gray-500 bg-white/50 hover:bg-gray-200">
                                    ...
                                    <main class="h-[55rem] flex-grow pt-6">
                                        ...
                                        <div class="mt-6 space-y-4 text-justify text-sm leading-snug">
                                            <p class="indent-8 px-5">Com os cumprimentos de estilo, a Universal nos
                                                ...
                                                evento.</p>
                                            <div>
                                                <p class="underline underline-offset-2 pl-5 pb-4">Descrição do evento:
                                                </p>
                                                <p class="italic font-bold mt-1 pl-4 pb-4 whitespace-pre-line">
                                                    <?php echo e($selectedOficio->descricao); ?></p>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedOficio->materiais): ?>
                                                    <p class="underline underline-offset-2 mt-2 pl-5">Requer ainda a
                                                        entrada dos materiais:</p>
                                                    <p class="mt-1 pl-4 italic font-bold whitespace-pre-line">
                                                        <?php echo e($selectedOficio->materiais); ?>
                    ...
                    <table class="w-full table-auto">
                        <thead class="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 uppercase text-sm">
                            <tr>
                                ...
                                <th class="py-3 px-6 text-left">Data do Evento</th>
                        ...
                        <tbody class="text-gray-600 dark:text-gray-300 text-sm">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $oficio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 animate-slide-up"
                                    ...
                                    <td class="py-3 px-6 text-left"><?php echo e($oficio->assunto); ?></td>
                                    <td class="py-3 px-6 text-left"><?php echo e($oficio->presidio->nome ?? 'N/A'); ?></td>
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex-1 space-y-1">
                                    <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                                        <?php echo e($oficio->assunto); ?></p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        <?php echo e($oficio->presidio->nome ?? 'N/A'); ?></p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Evento:
...
<?php /**PATH /home/moraws/dm/resources/views/livewire/unp/oficios/oficio-evento.blade.php ENDPATH**/ ?>