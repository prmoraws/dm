<?php $__env->startSection('title', 'Convidados'); ?>
 ...
 <?php $__env->slot('header', null, []); ?> 
    <div class="flex items-center space-x-3 animate-fade-in">
        ...
        <h2 class="capitalize font-semibold text-2xl text-gray-900 dark:text-gray-100 leading-tight">
            <?php echo e(__('Convidados e Voluntários')); ?>
                    ...
                    <div wire:key="create-edit-convidado"
                        ...
                        <div class="bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl w-full max-w-lg p-6"
                            ...
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">
                                <?php echo e($convidado_id ? 'Editar' : 'Criar'); ?> Convidado</h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="rg" id="rg"
                                        class="w-full rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['rg'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <select wire:model.defer="classe" id="classe"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $classeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['classe'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isViewOpen && $selectedConvidado): ?>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-lg p-6">
                            ...
                            <div class="space-y-4 text-gray-700 dark:text-gray-300">
                                <div>
                                    ...
                                    <p><?php echo e($selectedConvidado->nome); ?></p>
                                </div>
                                <div>
                                    <span class="font-semibold">CPF:</span>
                                    <p><?php echo e($selectedConvidado->cpf); ?></p>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedConvidado->rg): ?>
                                    <div>
                                        <span class="font-semibold">RG:</span>
                                        <p><?php echo e($selectedConvidado->rg); ?></p>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div>
                                    <span class="font-semibold">Classe:</span>
                                    <p class="capitalize"><?php echo e($selectedConvidado->classe); ?></p>
                                </div>
                            </div>
                ...
                <div class="hidden md:block overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
                    <table class="w-full table-auto">
                        ...
                        <tbody class="text-sm">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $convidado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 animate-slide-up"
                                    ...
                                    <td class="py-3 px-6 text-gray-700 dark:text-gray-300"><?php echo e($convidado->nome); ?></td>
                                    <td class="py-3 px-6 text-gray-700 dark:text-gray-300"><?php echo e($convidado->cpf); ?></td>
                                    <td class="py-3 px-6 text-gray-700 dark:text-gray-300 capitalize">
                                        <?php echo e($convidado->classe); ?></td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center space-x-3">
                                            <button wire:click="edit(<?php echo e($convidado->id); ?>)"
                                            ...
                                            <button wire:click="confirmDelete(<?php echo e($convidado->id); ?>)"
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex-1 space-y-1">
                                    <p class="text-lg font-bold text-gray-900 dark:text-gray-100">
                                        <?php echo e($convidado->nome); ?></p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">CPF: <?php echo e($convidado->cpf); ?></p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Classe: <span
                                            class="capitalize"><?php echo e($convidado->classe); ?></span></p>
                                </div>
                                <div class="flex flex-row items-center space-x-4 ml-4">
                                    
                                    <button wire:click="view(<?php echo e($convidado->id); ?>)"
...
<?php /**PATH /home/moraws/dm/resources/views/livewire/unp/oficios/convidados.blade.php ENDPATH**/ ?>