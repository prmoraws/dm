...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['options', 'placeholder' => 'Selecione...']));
...
foreach (array_filter((['options', 'placeholder' => 'Selecione...']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div x-data="{
    ...
    selectedValues: <?php if ((object) ($attributes->wire('model')) instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')->value()); ?>')<?php echo e($attributes->wire('model')->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e($attributes->wire('model')); ?>')<?php endif; ?>,
    ...
    <div @click="open = !open"
        ...
        <div class="flex flex-wrap gap-1.5 flex-grow">
            <template x-if="selectedValues.length === 0">
                <span class="text-gray-400 text-sm pl-1"><?php echo e($placeholder); ?></span>
            </template>
...
<?php /**PATH /home/moraws/dm/resources/views/components/advanced-select.blade.php ENDPATH**/ ?>