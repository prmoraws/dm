<?php $__env->startSection('title', 'Presídios'); ?>
                ...
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <p class="text-sm font-medium text-teal-800 dark:text-teal-200"><?php echo e(session('message')); ?>
                    ...
                    <div wire:key="create-edit-modal"
                        ...
                        <div
                            ...
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">
                                <?php echo e($presidio_id ? 'Editar Presídio' : 'Criar Presídio'); ?></h2>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="diretor" wire:model.defer="diretor"
                                            class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm dark:bg-gray-800 dark:text-gray-300"
                                            required>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['diretor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="contato_diretor" wire:model.defer="contato_diretor"
                                            class="w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm dark:bg-gray-800 dark:text-gray-300"
                                            required>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['contato_diretor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="flex justify-end gap-3 pt-6">
                                    ...
                                    <button type="submit"
                                        class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-5 rounded-lg"><?php echo e($presidio_id ? 'Atualizar' : 'Criar'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isViewOpen && $selectedPresidio): ?>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex flex-col">
                                    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">
                                        <?php echo e($selectedPresidio->nome); ?></h2>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 text-sm">
                                <p><strong class="text-gray-500 dark:text-gray-400">Diretor:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->diretor); ?></span>
                                </p>
                                <p><strong class="text-gray-500 dark:text-gray-400">Contato Diretor:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->contato_diretor); ?></span>
                                </p>
                                <p><strong class="text-gray-500 dark:text-gray-400">Adjunto:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->adjunto ?? 'N/A'); ?></span>
                                </p>
                                <p><strong class="text-gray-500 dark:text-gray-400">Contato Adjunto:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->contato_adjunto ?? 'N/A'); ?></span>
                                </p>
                                <p><strong class="text-gray-500 dark:text-gray-400">Laborativa:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->laborativa ?? 'N/A'); ?></span>
                                </p>
                                <p><strong class="text-gray-500 dark:text-gray-400">Contato Laborativa:</strong> <span
                                        class="text-gray-900 dark:text-gray-200"><?php echo e($selectedPresidio->contato_laborativa ?? 'N/A'); ?></span>
                                </p>
                                <div class="md:col-span-2 pt-2">
                                    ...
                                    <p class="text-gray-800 dark:text-gray-300 mt-1 whitespace-pre-wrap">
                                        <?php echo e($selectedPresidio->visita ?: 'Não informado'); ?></p>
                                </div>
                                <div class="md:col-span-2 pt-2">
                ...
                <div class="hidden md:block overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
                    <table class="w-full table-auto">
                        ...
                        <tbody class="text-gray-600 dark:text-gray-300 text-sm">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $presidios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $presidio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr wire:key="presidio-<?php echo e($presidio->id); ?>"
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center space-x-3">
                                            ...
                                            <button wire:click="edit(<?php echo e($presidio->id); ?>)"
                                            ...
                                            <button wire:click="confirmDelete(<?php echo e($presidio->id); ?>)"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presidios->hasPages()): ?>
                    <div class="pt-4"><?php echo e($presidios->links()); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/moraws/dm/resources/views/livewire/unp/presidios.blade.php ENDPATH**/ ?>