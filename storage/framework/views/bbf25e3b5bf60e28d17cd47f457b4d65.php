<div>
    <?php $__env->startSection('title', 'Dashboard Batismos'); ?>
        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border-b-4 border-blue-600">
                    <p class="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Batizados
                        Estado (Ano)</p>
                    <p class="text-4xl font-extrabold text-gray-900 dark:text-gray-100 mt-2"><?php echo e($totalAno); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border-b-4 border-teal-500">
                    <p class="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Batizados
                        Estado (Mês)</p>
                    <p class="text-4xl font-extrabold text-gray-900 dark:text-gray-100 mt-2"><?php echo e($totalMes); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border-b-4 border-amber-500">
                    <p class="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Batizados
                        Estado (Dia)</p>
                    <p class="text-4xl font-extrabold text-gray-900 dark:text-gray-100 mt-2"><?php echo e($totalDia); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $blocosMapeados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bloco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-gray-100 dark:bg-gray-700 px-4 py-3 rounded-lg flex items-center space-x-3">
                            <span
                                class="text-sm font-semibold text-gray-700 dark:text-gray-300"><?php echo e($bloco->nome); ?>:</span>
                            <span
                                class="bg-blue-600 text-white text-xs font-bold px-2.5 py-1 rounded-full"><?php echo e($bloco->total_mes_atual); ?></span>
                        </div>
                ...
                <div class="overflow-x-auto rounded-lg shadow border border-gray-200 dark:border-gray-700">
                    <table class="w-full table-auto">
                        ...
                        <tbody
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $presidiosTabela; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presidio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    <td class="py-3 px-6 text-left font-medium"><?php echo e($presidio->nome); ?></td>
                                    <td class="py-3 px-6 text-center">
                                        <span
                                            class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($presidio->total_mes_atual > 0 ? 'bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200' : 'bg-gray-100 text-gray-400 dark:bg-gray-800'); ?>">
                                            <?php echo e($presidio->total_mes_atual); ?>
...
<?php /**PATH /home/moraws/dm/resources/views/livewire/unp/dashboard-batismo.blade.php ENDPATH**/ ?>