<?php $__env->startSection('title', 'Blocos'); ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <div class="w-full md:w-1/3">
                        <input type="text" wire:model.live.debounce.300ms="search"
                            ...
                            placeholder="Digite para filtrar blocos...">
                    </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isOpen): ?>
                    <div wire:key="create-edit-modal" x-data="{ open: <?php echo json_encode($isOpen, 15, 512) ?> }" x-show="open"
                        ...
                        <div class="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-md mx-4 p-6 md:p-8">
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">
                                <?php echo e($bloco_id ? 'Editar Bloco' : 'Criar Bloco'); ?>
                            ...
                            <form wire:submit.prevent="store" class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" id="nome" wire:model.defer="nome"
                                        ...
                                        placeholder="Digite o nome do bloco" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="flex justify-end gap-3">
                                    ...
                                    <button type="submit"
                                        ...
                                        <?php echo e($bloco_id ? 'Atualizar' : 'Criar'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($confirmDeleteId): ?>
                    <div wire:key="delete-modal" x-data="{ open: <?php echo json_encode($confirmDeleteId, 15, 512) ?> }" x-show="open"
                        ...
                        class="fixed inset-0 bg-black bg-opacity-75 backdrop-blur-md flex items-center justify-center z-50">
                        <div
                            class="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-md mx-auto p-6 md:p-8">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">Tem certeza de que deseja excluir
                                este bloco? Esta ação é irreversível.</p>
                            <div class="flex justify-end gap-3">
                ...
                <div class="hidden md:block overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
                    <table class="w-full table-auto">
                        ...
                        <tbody class="text-gray-600 dark:text-gray-300 text-sm">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bloco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr wire:key="bloco-<?php echo e($bloco->id); ?>"
                                    ...
                                    style="--delay: <?php echo e((($index % 20) + 1) * 0.05); ?>s;">
                                    <td class="py-3 px-6 text-left"><?php echo e($bloco->id); ?></td>
                                    <td class="py-3 px-6 text-left"><?php echo e($bloco->nome); ?></td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <button wire:click="edit(<?php echo e($bloco->id); ?>)"
                                            ...
                                            <button wire:click="confirmDelete(<?php echo e($bloco->id); ?>)"
                                            ...
                                            <button wire:click="teste(<?php echo e($bloco->id); ?>)"
                                                class="w-4 transform hover:text-green-500 hover:scale-110 transition-all duration-150"
                                                aria-label="Testar clique">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3" class="py-3 px-6 text-center text-gray-500 dark:text-gray-400">
                                        Nenhum bloco encontrado para o termo "<?php echo e($search); ?>".
                                    </td>
                                </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </tbody>
                ...
                <div class="md:hidden space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bloco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div wire:key="bloco-card-<?php echo e($bloco->id); ?>" x-data="{ show: true }" x-show="show"
                            x-transition:enter="transition ease-out duration-300"
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">ID:
                                        <?php echo e($bloco->id); ?></p>
                                    <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                                        <?php echo e($bloco->nome); ?></p>
                                </div>
...
<?php /**PATH /home/moraws/dm/resources/views/livewire/universal/blocos.blade.php ENDPATH**/ ?>