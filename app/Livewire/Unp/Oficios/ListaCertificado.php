...
class ListaCertificado extends Component
{
    ...
    public function updatedCursoId($cursoId)
    {
        ...
        // NOVO: Altera a chave para forçar a re-renderização do advanced-select
        $this->reeducandoSelectKey = rand(); 
        // Não precisamos mais do dispatch('reeducandoOptionsLoaded') se usarmos wire:key
    }
