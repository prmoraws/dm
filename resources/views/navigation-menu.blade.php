                        ...
                        $menus = [
                            ...
                            'Política' => [
                                ...
                                'links' => [
                                    ...
                                    ['route' => 'politica.eleicoes-2026', 'label' => 'Eleições 2026'],
                                    ['route' => 'politica.acompanhamento', 'label' => 'Acompanhamento'],
                                    ['route' => 'politica.historico-acompanhados', 'label' => 'Histórico Acompanhados'],
                                    ['route' => 'politica.comparativo-territorial', 'label' => 'Comparativo Territorial'],
                                    ['route' => 'politica.inteligencia-territorial', 'label' => 'Inteligência Territorial'],
                                    ['route' => 'politica.painel-executivo', 'label' => 'Painel Executivo'],
                                    ['route' => 'politica.cidades', 'label' => 'Espelho Inteligente'],
                                    ['route' => 'politica.mapa', 'label' => 'Mapa Eleitoral'],
                                    ['route' => 'politica.qualidade-dados', 'label' => 'Qualidade e Auditoria'],
