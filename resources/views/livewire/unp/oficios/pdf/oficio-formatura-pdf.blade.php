...
<head>
    <meta charset="UTF-8">
    <title>Ofício de Formatura</title>
    <style>
    ...
    <main>
        ...
        <div class="corpo">
            <p>Com os cumprimentos de estilo, a Universal nos Presídios - UNP, vem, através de seu Coordenador Geral que
                a este subscreve, requerer autorização para realizar a <span
                    style="font-weight: bold;">{{ $selectedOficio->evento_formatado }}</span>. No dia os voluntários
                precisam entrar pela manhã 8h para fazer a arrumação do evento.</p>

            <div class="secao">
                <p class="secao-titulo">Requer ainda autorização de entrada dos materiais de apoio:</p>
                <p class="secao-conteudo">{{ $selectedOficio->materiais }}</p>
            </div>
            <div class="secao">
                <p class="secao-titulo">Materiais da comunicação:</p>
                <p class="secao-conteudo">{{ $selectedOficio->comunicacao }}</p>
            </div>

            <p class="obs">Cumpre salientar nossa Instituição continua comprometida a corroborar com os cuidados
                necessários em que
