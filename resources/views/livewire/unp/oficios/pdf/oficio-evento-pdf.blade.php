    ...
    <main>
        ...
        <div class="corpo">
            <p>Com os cumprimentos de estilo, a Universal nos Presídios - UNP, vem, através de seu Coordenador Geral que
                a este subscreve, requerer autorização para realizar o evento <span
                    style="font-weight: bold;">{{ $selectedOficio->evento_formatado }}</span>.</p>

            <div class="secao">
                <p class="secao-titulo">Descrição do evento:</p>
                <p class="secao-conteudo">{{ $selectedOficio->descricao }}</p>
            </div>

            @if ($selectedOficio->materiais)
                <div class="secao">
                    <p class="secao-titulo">Requer ainda a entrada dos seguintes materiais:</p>
